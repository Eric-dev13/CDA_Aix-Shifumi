...
function algoShifoumi(){
    ...
    root.innerHTML = `
        <p class="score">Partie ${compteurPartie} / ${nombreDePartie}</p>
        <p>
            <span>${pseudoJoueur1}</span> a choisi <img src="${getInfoImage(choixJoueur1).path}" width=50 > /
            <span>${pseudoJoueur2}</span> a choisi <img src="${getInfoImage(choixJoueur2).path}" width=50 >
        </p>
    `
    root.querySelector("p.score").style.cssText = `font-weight:bold;`
